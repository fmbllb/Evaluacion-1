...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('aplicacion', '0009_remove_boleta_fk_usuario'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='customuser_permission_set', related_query_name='customuser', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
